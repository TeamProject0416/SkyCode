...
public class EventService {
    ...
    public EventFormDto getEventDtl(Long eventId) {
        ...
        System.out.println("---------------------------");
        System.out.println(eventFormDto.getMiniImgName());
        System.out.println(eventFormDto.getMiniImgUrl());
        System.out.println(eventFormDto.getMiniOriImgName());
        System.out.println("---------------------------");
        System.out.println(eventFormDto.getBigImgName());
        System.out.println(eventFormDto.getBigImgUrl());
        System.out.println(eventFormDto.getBigOriImgName());
        System.out.println("---------------------------");
